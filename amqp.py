...
class AmqpProtocol(AMQClient):
    ...
    @inlineCallbacks
    def _send_message(self, exchange, queue, routing_key, msg):
...
class AmqpFactory(protocol.ReconnectingClientFactory):
    ...
    def __init__(self, spec_file=None, vhost=None, host=None, port=None, user=None, password=None):
        spec_file = spec_file or 'amqp0-9-1.stripped.xml'
    ...
    def send_message(self, exchange=None, queue=None, routing_key=None, msg=None):
        """Send a message."""
        # Add the new message to the queue.
        self.queued_messages.append((exchange, queue, routing_key, msg))
